  ...
  Future<void> fetchDiagnosis() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final diagnosisCategory = categories.firstWhereOrNull(
          (cat) => cat.id == 12 || cat.name == 'Diagnosis',
        );
        if (diagnosisCategory != null) {
          diagnosisCategoryId.value = diagnosisCategory.id ?? 0;
          final subcategories = diagnosisCategory.diagnosisSubcategories ?? [];
