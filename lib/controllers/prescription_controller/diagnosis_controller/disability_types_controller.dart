  ...
  Future<void> fetchDisabilityTypes() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final disabilityCategory = categories.firstWhere(
          (cat) => cat['id'] == 11 || cat['name'] == 'Types of Disabilities',
          orElse: () => null,
        );
      if (disabilityCategory != null) {
          disabilityTypesCategoryId.value = disabilityCategory['id'] as int? ?? 0;
          final subcategories = disabilityCategory['diagnosis_subcategories'] as List<dynamic>;
