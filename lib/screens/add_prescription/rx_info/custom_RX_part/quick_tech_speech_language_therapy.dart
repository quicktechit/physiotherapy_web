...
class CustomSpeechLanguageTherapyInfo extends StatefulWidget {
  @override
  _CustomSpeechLanguageTherapyInfoState createState() =>
      _CustomSpeechLanguageTherapyInfoState();
}

class _CustomSpeechLanguageTherapyInfoState
    extends State<CustomSpeechLanguageTherapyInfo> {
  final QuickTechSpeechLanguageTherapyController speechLanguageTherapyController =
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (speechLanguageTherapyController.categories.isEmpty) {
        speechLanguageTherapyController.fetchTherapies();
      }
    });
  ...
  Widget build(BuildContext context) {
    return customExpansionTile('Speech and Language Therapy');
  }
      ...
      child: Obx(
        () => ExpansionTile(
          ...
          onExpansionChanged: (expanded) {
            speechLanguageTherapyController.isMiscellaneousTherapyClicked.value =
                expanded;
          },
          children: [
            Column(
              children: [
                ...
                SizedBox(height: 10),
                for (int i = 0;
                    i < speechLanguageTherapyController.categories.length;
                    i++)
                  if (_matchesSearchQuery(
                    speechLanguageTherapyController.categories[i],
                  ))
                    CustomCategoryCard(
                      speechLanguageTherapyController.categories[i],
                      i,
  ...
  bool _matchesSearchQuery(SpeechLanguageTherapy category) {
    ...
    if (category.subcategories != null) {
      for (var sub in category.subcategories!) {
        if (sub.name.toLowerCase().contains(searchQuery)) {
          return true;
        }
      }
    }
  ...
  Widget customSelectedTherapyList() {
    return speechLanguageTherapyController.selectedTherapies.isEmpty
        ? Text(
        ...
        : Column(
            ...
            children: speechLanguageTherapyController.selectedTherapies
                .map(
                  (therapy) => Padding(
  ...
  Widget CustomCategoryCard(SpeechLanguageTherapy category, int categoryIndex) {
    return Card(
      color: themeController.isDay.value
          ? QuickTechAppColors.white
        ...
        children: [
          ListTile(
            ...
            trailing: Checkbox(
              ...
              onChanged: (value) {
                speechLanguageTherapyController.toggleCategorySelection(
                  categoryIndex,
                );
              },
            ),
  ...
  Widget customSubcategoryItem(
      SpeechLanguageTherapy category, int categoryIndex, int subcategoryIndex) {
    final sub = category.subcategories![subcategoryIndex]; // Subcategory object
    ...
    return Column(
      children: [
        CheckboxListTile(
          ...
          onChanged: (value) {
            speechLanguageTherapyController.toggleSubcategorySelection(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    onChanged: (value) {
                      sub.note = value;
                      speechLanguageTherapyController.updateSubcategoryNote(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Text field
                        TextField(
                          autofocus: true,                        maxLength: 255,                          maxLines: 8,
                          minLines: 6,
                ...
                // ═══════════════════════════════════════════════════════
                if (speechLanguageTherapyController.customTherapies.isNotEmpty)
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // Section title
                      Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              '${speechLanguageTherapyController.customTherapies.length}',
                              style: myStyle(
                                10,
                ...
                // EMPTY STATE
                // ═══════════════════════════════════════════════════════
                if (speechLanguageTherapyController.customTherapies.isEmpty &&
